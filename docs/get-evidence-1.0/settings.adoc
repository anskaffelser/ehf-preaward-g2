...
:link-request: xsd/maindoc/UBL-QualificationApplicationRequest-2.2.xsd[Request]
:link-resonse: http://docs.oasis-open.org/ubl/os-UBL-2.2/xsd/maindoc/UBL-QualificationApplicationResponse-2.2.xsd[Response]
