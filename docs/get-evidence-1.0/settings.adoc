...
:link-codelist: /ehf-pre/g2/codelist/
:codelist-ICD: /ehf-pre/g2/codelist/ICD/[ICD Code list]
:eas: /ehf-pre/g2/codelist/EAS/[Code list for electronic address scheme]
