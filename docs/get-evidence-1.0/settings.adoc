...
:link-codelist: /ehf-pre/guide/getevidence/1.0/codelist/[Code list section]
:codelist-ICD: /ehf-pre/guide/getevidence/1.0/codelist/ICD/[ICD list]
:eas: /ehf-pre/guide/getevidence/1.0/codelist/EAS/[Code list for electronic address scheme]
